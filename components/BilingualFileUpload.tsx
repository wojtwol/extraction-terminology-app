  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
      ...
      <div className="mb-6">
        ...
        <input type="text" name="fake-username-b" style={{display: 'none'}} autoComplete="username" />
        <input type="password" name="fake-password-b" style={{display: 'none'}} autoComplete="new-password" />
        <input
          type="password"
          value={apiKey}
          ...
          data-form-type="other"
          data-lpignore="true"
          name="anthropic-api-key-bilingual"
        />
